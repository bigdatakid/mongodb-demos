...
mongod --auth  --keyFile ./mongodb-key-file  --replSet replKey --fork --dbpath /tmp/mongod/11/data/ --logpath /tmp/mongod/11/log/mongod11_log.txt --port 27011
mongod --auth  --keyFile ./mongodb-key-file  --replSet replKey --fork --dbpath /tmp/mongod/12/data/ --logpath /tmp/mongod/12/log/mongod12_log.txt --port 27012 
